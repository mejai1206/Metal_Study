...
//    This is where we will do most of our work.
    func draw(in view: MTKView) {
        ...
        //transform
        let aspect = Float(view.bounds.height) / Float(view.bounds.width)
        var scaleMat = matrix_identity_float4x4
        //scaleMat.columns.0 = [aspect, 0.0, 0.0, 0.0];
        renderCommandEncoder.setVertexBytes(&scaleMat, length:MemoryLayout<float4x4>.stride, index: 1)
